...
I originally wrote this back in the mid 2000's as a personal reference to figure this sport out. I've recently updated this, trying to slightly modernize it while keeping the original premise intact (as a reference for new players).
...
- [Fouls]({{< ref "01a-fouls.md" >}})
- [Equipment]({{< ref "02-equipment.md" >}})
- [Fitness]({{< ref "03-skills.md" >}})
- [Puck Handling]({{< ref "03a-puck-handling.md" >}})
- [Underwater Hockey Positions]({{< ref "04-positions.md" >}})
...
- [Tournament Checklist]({{< ref "15-tournament-checklist.md" >}})
- [Practice Drills]({{< ref "16-practice-drills.md" >}})
