...
status = "publish"
tags = ["development","software","coding","web","html","JavaScript","CoffeeScript","EMCAScript","C#",".NET","algorithms","cracking the coding interview","interviewing","linked list","runner technique","slow pointers","fast pointers"]
layout = "post"
+++
